        ...
        <section className="space-y-3 rounded-lg border border-slate-200 bg-slate-50 p-3 dark:border-slate-700 dark:bg-slate-900">
          <div className="flex flex-wrap items-end gap-3">
            <form className="flex flex-wrap items-end gap-3">
              ...
              <button className="rounded-md bg-portoBlue px-4 py-2 text-sm font-semibold text-white hover:bg-portoDark">Ver mes</button>
            </form>
            <div className="flex gap-2">
              <Link href={calendarHref({ campus: data.selectedCampusId, month: previousMonth })} className="rounded-md border border-slate-300 bg-white px-3 py-2 text-sm hover:bg-slate-50 dark:border-slate-600 dark:bg-slate-950 dark:hover:bg-slate-800">
                Mes anterior
              </Link>
              <Link href={calendarHref({ campus: data.selectedCampusId, month: nextMonth })} className="rounded-md border border-slate-300 bg-white px-3 py-2 text-sm hover:bg-slate-50 dark:border-slate-600 dark:bg-slate-950 dark:hover:bg-slate-800">
                Mes siguiente
              </Link>
            </div>
          </div>
