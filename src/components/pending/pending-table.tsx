    ...
    <div className="min-w-[180px] space-y-1.5">
      ...
      {contacted ? (
        <textarea
          ...
          rows={2}
          className="w-full resize-none rounded border border-slate-300 bg-white px-2 py-1 text-xs dark:border-slate-600 dark:bg-slate-800"
        />
      ) : null}
          ...
          rows.map((row) => (
            <div
              ...
              className={`space-y-3 rounded-md border px-4 py-4 dark:border-slate-700 ${
                row.contactadoAt ? "border-emerald-200 bg-emerald-50/40 dark:bg-emerald-950/20" : "border-slate-200"
              }`}
            >
