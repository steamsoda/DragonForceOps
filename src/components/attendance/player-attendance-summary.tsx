...
const STATUS_META: Record<string, { symbol: string; className: string; label: string }> = {
  present: { symbol: "A", className: "bg-emerald-100 text-emerald-800 border-emerald-300", label: "A Asistió" },
  absent: { symbol: "F", className: "bg-rose-100 text-rose-800 border-rose-300", label: "F Falta" },
  injury: { symbol: "🩹", className: "bg-sky-100 text-sky-800 border-sky-300", label: "🩹 Lesión" },
  justified: { symbol: "📝", className: "bg-slate-100 text-slate-700 border-slate-300", label: "📝 Justificada" },
};
