...
assert.match(page, /border-sky-200/, "Category sections should have a visible boundary.");
assert.match(page, /groupIndex % 2 === 0/, "Group rows should alternate subtle backgrounds.");
assert.match(page, /print:bg-white/, "Printed reports should remain background-neutral.");
