...
assert.doesNotMatch(page, /WeeklyCallupComposerForm/);
assert.doesNotMatch(page, /Preparar convocatoria semanal/);
...
assert.match(dashboard, /createWeeklyCallupComposerAction/);
assert.match(dashboard, /name="squadId"/);
assert.match(dashboard, /Preparar convocatoria/);
assert.match(dashboard, /Descargar PNG/);
assert.match(dashboard, /Ver detalle/);
assert.match(dashboard, /setSelection/);
assert.match(dashboard, /\.filter\(\(group\) => group\.campusId === selection\.campusId/);
