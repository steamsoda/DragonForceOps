...
assert.match(composer, /expandedGroupId/);
assert.match(composer, /aria-expanded=\{expanded\}/);
assert.match(composer, /Grupo omitido/);
assert.match(composer, /Sin reporte del coach/);
assert.match(composer, /type="hidden" name=\{`tournamentId:/);
assert.match(composer, /firstErrorGroupId/);
