...
assert.match(coachAction, /loadFreshSquadRoster/);
assert.match(coachAction, /game_roster_changed/);
assert.match(coachForm, /Plantel actualizado/);
assert.match(coachForm, /data-validation-field/);
