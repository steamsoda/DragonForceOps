...
const [migration, coachQuery, coachForm, coachAction, callupAction, callupQuery, png, dashboard, page] = await Promise.all([
...
assert.match(coachAction, /save_coach_weekly_schedule_report_v2/);
