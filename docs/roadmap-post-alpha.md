...
- Current preview line: `v1.16.211`
...
| 🟢 | Tryout classes Pass 1 | Preview `v1.16.210`-`v1.16.211` adds the isolated pre-enrollment foundation plus non-destructive intake validation: required child/contact data, exact 10-digit tutor phone, non-future birth date, campus/group choice, duplicate-aware search, three-visit counter, idempotent current-session arrival, dated history/notes, and printable/reprintable thermal ticket. It does not write normal attendance, enrollment, charge, or payment rows. | `docs/planning/trial-classes-plan.md`, `v1.16.210`-`v1.16.211` devlog |
...
| 🟢 | Tryout classes workflow | Preview `v1.16.210`-`v1.16.211` implements Pass 1 with an isolated prospect/visit ledger, Front Desk intake/check-in/ticket surface, and form-preserving validation. Pass 2 adds separate daily-attendance awareness without changing roster/KPI denominators; Pass 3 converts a prospect through the existing enrollment confirmation, B1 assignment, and Caja handoff; Pass 4 adds conversion reporting; Pass 5 adds override and duplicate hardening. | `docs/planning/trial-classes-plan.md`, `v1.16.210`-`v1.16.211` devlog |
