...
- Current production line: `v1.17.56`
- Current preview candidate: `v1.17.57` prevents payment/credit double use, makes mixed credit/payment tournament funding register consistently, clarifies applied credit on receipts, and contains exact-state repairs for the two confirmed Front Desk incidents.
