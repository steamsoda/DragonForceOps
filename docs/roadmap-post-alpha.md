...
Last reorganized: 2026-05-06. Last checkpoint: 2026-08-10 (`v1.17.22`).
...
- Current preview candidate: `v1.17.22` adds explicit coach-account linking, assigned-group-only weekly schedule reporting, visible/editable submission status, a tightly scoped writable Preview test mode, and admin convocatoria handoff
...
11. 🟢 `v1.17.20`-`v1.17.22` add explicit coach-account linking, assigned-group-only schedule reporting, visible/editable submitted games, a schedule-only writable Preview test mode, and admin handoff; directors/admins retain paid-roster control, exceptions, deletion, and final WhatsApp-image generation.
...
| 🟢 | Coach match posting v1 | Preview `v1.17.20`-`v1.17.22` links one auth account to one coach, allows schedule-only reporting for assigned groups, keeps submitted games visibly editable, and permits only this workflow during Super Admin Preview impersonation. Validate multi-game handoff before production. |
