...
- Current preview candidate: `v1.16.241`
...
|---|---|---|---|
| 🟢 | Weekly WhatsApp convocatorias Pass 1-3C-1 | Preview `v1.16.236`-`v1.16.241` adds the frozen Combo-aware roster, operational editor, controlled exceptions/refresh, direct PNG, large-packet fitting, and a campus/program composer with tournament selection per group. Inline quick exclusions and final hardening remain. | `docs/planning/weekly-callups-plan.md`, Competencias |
...
| 🟢 | WhatsApp weekly convocatoria workflow | Preview `v1.16.236`-`v1.16.241` provides the frozen roster, core editor, controlled exceptions/refresh, direct one-image PNG, adaptive fitting, and the per-group tournament composer. Inline quick exclusions remain before final hardening. | `docs/planning/weekly-callups-plan.md`, Competencias |
