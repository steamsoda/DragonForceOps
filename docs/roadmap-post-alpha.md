...
- Current preview candidate: `v1.16.242`
...
|---|---|---|---|
| 🟢 | Weekly WhatsApp convocatorias Pass 1-3C-2 | Preview `v1.16.236`-`v1.16.242` adds the frozen Combo-aware roster, operational editor, controlled exceptions/refresh, direct PNG, large-packet fitting, per-group tournament composer, ready-first editing, coach labels, and safe packet deletion. Inline quick exclusions and final hardening remain. | `docs/planning/weekly-callups-plan.md`, Competencias |
...
| 🟢 | WhatsApp weekly convocatoria workflow | Preview `v1.16.236`-`v1.16.242` provides the frozen roster, core editor, controlled exceptions/refresh, direct one-image PNG, adaptive fitting, per-group tournament composer, ready-first editing, coach labels, and safe packet deletion. Inline quick exclusions remain before final hardening. | `docs/planning/weekly-callups-plan.md`, Competencias |
