...
- Current preview candidate: `v1.16.239`
...
|---|---|---|---|
| 🟢 | Weekly WhatsApp convocatorias Pass 1-3A | Preview `v1.16.236`-`v1.16.239` adds the frozen Combo-aware roster, operational editor, controlled exceptions/refresh, and direct one-image PNG download. Fitting polish, editor simplification, and final hardening remain. | `docs/planning/weekly-callups-plan.md`, Competencias |
...
| 🟢 | WhatsApp weekly convocatoria workflow | Preview `v1.16.236`-`v1.16.239` provides the frozen roster, core editor, controlled exceptions/refresh, and direct one-image PNG download. Category fitting/order polish and editor simplification remain before final hardening. | `docs/planning/weekly-callups-plan.md`, Competencias |
