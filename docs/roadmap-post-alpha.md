...
- Current preview line: `v1.16.156`
...
| 🟢 | Caja account credit ledger / partial refund model | Preview `v1.16.154` adds the additive schema foundation, `v1.16.155` adds read-only Caja display, and `v1.16.156` adds guarded explicit `Usar credito` for selected charges. Legacy implicit credit conversion remains out of scope. |
