...
- Current preview line: `v1.16.191`
...
- 🟢 `Jugadores` roster export/print attendance history: preview `v1.16.191` adds the last 15 recorded attendance entries to the Excel export and a direct `Imprimir listas` roster printout.
...
| 🟢 | `Jugadores` roster export/print attendance history | Preview `v1.16.191` adds the last 15 recorded attendance entries to the grouped roster Excel export and a direct compact roster print action. | Jugadores, `v1.16.191` devlog |
