...
Last reorganized: 2026-05-06. Last checkpoint: 2026-08-11 (`v1.17.37`). Active release: `v1.17.57`.
...
- Current production line: `v1.17.57`
- Current preview line: `v1.17.57` prevents payment/credit double use, makes mixed credit/payment tournament funding register consistently, clarifies applied credit on receipts, and includes verified production repairs for the two confirmed Front Desk incidents.
