...
- Current preview candidate: `v1.16.240`
...
|---|---|---|---|
| 🟢 | Weekly WhatsApp convocatorias Pass 1-3B | Preview `v1.16.236`-`v1.16.240` adds the frozen Combo-aware roster, operational editor, controlled exceptions/refresh, direct PNG, and large-packet fitting/order hardening. Editor simplification and final hardening remain. | `docs/planning/weekly-callups-plan.md`, Competencias |
...
| 🟢 | WhatsApp weekly convocatoria workflow | Preview `v1.16.236`-`v1.16.240` provides the frozen roster, core editor, controlled exceptions/refresh, direct one-image PNG, and adaptive large-packet fitting. Editor simplification remains before final hardening. | `docs/planning/weekly-callups-plan.md`, Competencias |
